...
<main class="mx-auto flex min-h-screen max-w-2xl flex-col items-center justify-center px-6 text-center">
  <div class="mb-8"><img src="/images/me%20lon%20pc.webp" alt="A photo of Luke Henderson" class="home-avatar h-40 w-40 rounded-full object-cover shadow-lg ring-2 ring-gray-200" /></div>
